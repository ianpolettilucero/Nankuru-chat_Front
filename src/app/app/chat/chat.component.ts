...
export class ChatComponent implements OnInit, AfterViewChecked {
  ...
  currentView:string = "click to view DMs";
  serverDisplay:boolean = true;

  changeView(){
    if(this.currentView == "click to view DMs"){
      this.currentView = "click to view Servers";
      this.serverDisplay = false;
    }
    else{
      this.currentView = "click to view DMs";
